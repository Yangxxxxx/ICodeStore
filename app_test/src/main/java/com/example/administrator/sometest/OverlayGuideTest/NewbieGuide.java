...
public class NewbieGuide {
    ...
    private View profileViw;
    public void addView(View view){
        mGuideView.addView(view);
        profileViw = view;
        mGuideView.setOnHighlightRect(onHighlightRect);
    }

    private GuideView.OnHighlightRect onHighlightRect = new GuideView.OnHighlightRect() {
        @Override
        public void onHighlightRect(RectF rec) {
            profileViw.setTranslationX(rec.left);
            profileViw.setTranslationY(rec.top - 25 * 3);
        }
    };
