...
//                                .addIndicateImg(R.drawable.left_arrow, ScreenUtils.dpToPx(mActivity, 60), ScreenUtils.dpToPx(mActivity, 110))
                    ...
                    case TYPE_COLLECT:
//                        mNewbieGuide
////                                .addIndicateImg(R.drawable.right, ScreenUtils.dpToPx(mActivity, -70), ScreenUtils.dpToPx(mActivity, 50))
//                                .addMsgAndKnowTv("写了一个测试的，随便点击哪里都可以\n废话就不那么多了，你们看看吧", ScreenUtils.dpToPx(mActivity, 150))
//                                .show();
                            View view = LayoutInflater.from(mActivity).inflate(R.layout.layout_guide_profile, null);
                        TextView textView = view.findViewById(R.id.tv_hint);
                        Log.e("yang", "haha textview: " + textView.getLeft() + " " + textView.getTop());
                        mNewbieGuide.addView(view);
                        mNewbieGuide.show();
