...
public class NumberPanel extends RecyclerView{
    private final int MAX_NUMBER = 61;
    ...
    class NumberAdapter extends RecyclerView.Adapter<NumberAdapter.NumberViewHolder> implements View.OnClickListener{
        ...
        public void onBindViewHolder(NumberViewHolder holder, int position) {
            String number = (position < 10 ? "0" : "") + String.valueOf(position);
