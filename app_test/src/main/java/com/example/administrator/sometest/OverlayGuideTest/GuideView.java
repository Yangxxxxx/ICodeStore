...
public class GuideView extends RelativeLayout {
	...
	private OnHighlightRect onHighlightRect;
	...
	public void setOnHighlightRect(OnHighlightRect onHighlightRect){
		this.onHighlightRect = onHighlightRect;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mHoleList != null && mHoleList.size() > 0) {
			...
			for (HoleBean hole : mHoleList) {
				...
				onHighlightRect.onHighlightRect(hole.getRectF());
			}
	...
	public interface OnHighlightRect{
		void onHighlightRect(RectF rec);
	}
