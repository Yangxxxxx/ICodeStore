...
public  class STextureRender {
    ...
    private float TRANSFORM_RECTANGLE_COORDS[] = {
    ...
    private  FloatBuffer TRANSFORM_RECTANGLE_BUF =
            GlUtil.createFloatBuffer(TRANSFORM_RECTANGLE_COORDS);
    private  final FloatBuffer TRANSFORM_RECTANGLE_TEX_BUF =
    ...
    public void setRectCoor(float[] coor){
        TRANSFORM_RECTANGLE_BUF = GlUtil.createFloatBuffer(coor);
    }

    /**
     * Draws the external texture in SurfaceTexture onto the current EGL surface.
     */
    public void drawFrame(int frameBufferID, boolean invert) {
