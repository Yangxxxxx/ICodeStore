...
/** 系统控件TabLayout的自定义修改
 * 目的：把Indicator的位置放到上面；
 * 代价：addView系列方法就不能用了*/

@ViewPager.DecorView
public class TabLayoutLocal extends HorizontalScrollView {
    ...
    private static final Pools.Pool<TabLayoutLocal.Tab> sTabPool = new Pools.SynchronizedPool<>(16);
    ...
    /**
     * Gravity used to fill the {@link TabLayoutLocal} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link TabLayoutLocal}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public interface OnTabSelectedListener {
         ...
         */
        public void onTabSelected(TabLayoutLocal.Tab tab);
         ...
         */
        public void onTabUnselected(TabLayoutLocal.Tab tab);
         ...
         */
        public void onTabReselected(TabLayoutLocal.Tab tab);
    }

    private final ArrayList<TabLayoutLocal.Tab> mTabs = new ArrayList<>();
    private TabLayoutLocal.Tab mSelectedTab;

    private final TabLayoutLocal.SlidingTabStrip mTabStrip;
    ...
    private TabLayoutLocal.OnTabSelectedListener mSelectedListener;
    private final ArrayList<TabLayoutLocal.OnTabSelectedListener> mSelectedListeners = new ArrayList<>();
    private TabLayoutLocal.OnTabSelectedListener mCurrentVpSelectedListener;
    ...
    private TabLayoutLocal.TabLayoutOnPageChangeListener mPageChangeListener;
    private TabLayoutLocal.AdapterChangeListener mAdapterChangeListener;
    private boolean mSetupViewPagerImplicitly;

    // Pool we use as a simple RecyclerBin
    private final Pools.Pool<TabLayoutLocal.TabView> mTabViewPool = new Pools.SimplePool<>(12);

    public TabLayoutLocal(Context context) {
        this(context, null);
    }

    public TabLayoutLocal(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabLayoutLocal(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        mTabStrip = new TabLayoutLocal.SlidingTabStrip(context);
     ...
     */
    public void addTab(@NonNull TabLayoutLocal.Tab tab) {
     ...
     */
    public void addTab(@NonNull TabLayoutLocal.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull TabLayoutLocal.Tab tab, boolean setSelected) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull TabLayoutLocal.Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        final TabLayoutLocal.Tab tab = newTab();
//        if (item.mText != null) {
...
//        }
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(TabLayoutLocal.OnTabSelectedListener)} and
     * {@link #removeOnTabSelectedListener(TabLayoutLocal.OnTabSelectedListener)}.
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable TabLayoutLocal.OnTabSelectedListener listener) {
    ...
    /**
     * Add a {@link TabLayoutLocal.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via
     * {@link #removeOnTabSelectedListener(TabLayoutLocal.OnTabSelectedListener)}.</p>
     *
     * @param listener listener to add
     */
    public void addOnTabSelectedListener(@NonNull TabLayoutLocal.OnTabSelectedListener listener) {
    ...
    /**
     * Remove the given {@link TabLayoutLocal.OnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(TabLayoutLocal.OnTabSelectedListener)}.
     *
     * @param listener listener to remove
     */
    public void removeOnTabSelectedListener(@NonNull TabLayoutLocal.OnTabSelectedListener listener) {
        mSelectedListeners.remove(listener);
    }

    /**
     * Remove all previously added {@link TabLayoutLocal.OnTabSelectedListener}s.
     */
    ...
    /**
     * Create and return a new {@link TabLayoutLocal.Tab}. You need to manually add this using
     * {@link #addTab(TabLayoutLocal.Tab)} or a related method.
     *
     * @return A new Tab
     * @see #addTab(TabLayoutLocal.Tab)
     */
    @NonNull
    public TabLayoutLocal.Tab newTab() {
        TabLayoutLocal.Tab tab = sTabPool.acquire();
        if (tab == null) {
            tab = new TabLayoutLocal.Tab();
        }
        tab.mParent = this;
     ...
     */
    @Nullable
    public TabLayoutLocal.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(TabLayoutLocal.Tab tab) {
        if (tab.mParent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final TabLayoutLocal.Tab removedTab = mTabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<TabLayoutLocal.Tab> i = mTabs.iterator(); i.hasNext();) {
            final TabLayoutLocal.Tab tab = i.next();
            i.remove();
            tab.reset();
     ...
     */
    public void setTabMode(@TabLayoutLocal.Mode int mode) {
        if (mode != mMode) {
            mMode = mode;
            applyModeAndGravity();
        }
    ...
    /**
     * Returns the current mode used by this {@link TabLayoutLocal}.
     *
     * @see #setTabMode(int)
     */
    @TabLayoutLocal.Mode
     ...
     */
    public void setTabGravity(@TabLayoutLocal.TabGravity int gravity) {
    ...
    /**
     * The one-stop shop for setting up this {@link TabLayoutLocal} with a {@link ViewPager}.
     *
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new TabLayoutLocal.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            mCurrentVpSelectedListener = new TabLayoutLocal.ViewPagerOnTabSelectedListener(viewPager);
            ...
            if (mAdapterChangeListener == null) {
                mAdapterChangeListener = new TabLayoutLocal.AdapterChangeListener();
            }
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new TabLayoutLocal.PagerAdapterObserver();
            }
    ...
    private TabLayoutLocal.TabView createTabView(@NonNull final TabLayoutLocal.Tab tab) {
        TabLayoutLocal.TabView tabView = mTabViewPool != null ? mTabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new TabLayoutLocal.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(TabLayoutLocal.Tab tab, int position) {
    ...
    private void addTabView(TabLayoutLocal.Tab tab) {
        final TabLayoutLocal.TabView tabView = tab.mView;
    ...
    private void removeTabViewAt(int position) {
        final TabLayoutLocal.TabView view = (TabLayoutLocal.TabView) mTabStrip.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == TabLayoutLocal.Tab.INVALID_POSITION) {
            return;
        }
    ...
    void selectTab(TabLayoutLocal.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(final TabLayoutLocal.Tab tab, boolean updateIndicator) {
        final TabLayoutLocal.Tab currentTab = mSelectedTab;
        ...
        if (currentTab == tab) {
            ...
            final int newPosition = tab != null ? tab.getPosition() : TabLayoutLocal.Tab.INVALID_POSITION;
            if (updateIndicator) {
                if ((currentTab == null || currentTab.getPosition() == TabLayoutLocal.Tab.INVALID_POSITION)
                        && newPosition != TabLayoutLocal.Tab.INVALID_POSITION) {
    ...
    private void dispatchTabSelected(@NonNull final TabLayoutLocal.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            mSelectedListeners.get(i).onTabSelected(tab);
        }
    }

    private void dispatchTabUnselected(@NonNull final TabLayoutLocal.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            mSelectedListeners.get(i).onTabUnselected(tab);
        }
    }

    private void dispatchTabReselected(@NonNull final TabLayoutLocal.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
    ...
    public static final class Tab {
        ...
        TabLayoutLocal mParent;
        TabLayoutLocal.TabView mView;
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setTag(@Nullable Object tag) {
            mTag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setCustomView(@Nullable View view) {
            mCustomView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setIcon(@Nullable Drawable icon) {
            mIcon = icon;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setText(@Nullable CharSequence text) {
            mText = text;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setText(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setContentDescription(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public TabLayoutLocal.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    class TabView extends LinearLayout {
        private TabLayoutLocal.Tab mTab;
        ...
        void setTab(@Nullable final TabLayoutLocal.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
        ...
        final void update() {
            final TabLayoutLocal.Tab tab = mTab;
        ...
        public TabLayoutLocal.Tab getTab() {
            return mTab;
        }
...
//            }
            ...
            // 把Indicator位置修改到上面
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft, 0, mIndicatorRight, mSelectedIndicatorHeight, mSelectedIndicatorPaint);
            }
        }
    }
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            TabLayoutLocal.Tab tab = mTabs.get(i);
     ...
     * necessary calls back to the provided {@link TabLayoutLocal} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabLayoutLocal> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(TabLayoutLocal tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final TabLayoutLocal tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link TabLayoutLocal.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements TabLayoutLocal.OnTabSelectedListener {
